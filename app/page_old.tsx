        ...
        <section className="bg-slate-950 py-24">
          <div className="mx-auto max-w-7xl space-y-16 px-6">
            <header className="max-w-4xl space-y-4">
              ...
              <h2 className="text-4xl font-bold leading-tight text-white md:text-5xl">What This System Does NOT Replace</h2>
            </header>
            <div className="grid gap-8 md:grid-cols-3">
              <article className="flex h-full flex-col rounded-2xl border border-slate-700/50 bg-slate-900/80 p-8 shadow-2xl shadow-black/40 backdrop-blur-sm">
                <div className="text-sm font-bold uppercase tracking-[0.25em] text-orange-400">HRIS</div>
                <p className="mt-6 text-lg font-semibold leading-snug text-white">Human Resource Information Systems</p>
                <p className="mt-4 text-base leading-relaxed text-slate-400">Employment records remain in your existing HR system</p>
                <div className="mt-6 h-1 w-16 bg-orange-500/90" />
              </article>
              <article className="flex h-full flex-col rounded-2xl border border-slate-700/50 bg-slate-900/80 p-8 shadow-2xl shadow-black/40 backdrop-blur-sm">
                <div className="text-sm font-bold uppercase tracking-[0.25em] text-orange-400">LMS</div>
                <p className="mt-6 text-lg font-semibold leading-snug text-white">Learning Management Systems</p>
                <p className="mt-4 text-base leading-relaxed text-slate-400">Training delivery and completion tracking remain in your existing systems</p>
                <div className="mt-6 h-1 w-16 bg-orange-500/90" />
              </article>
              <article className="flex h-full flex-col rounded-2xl border border-slate-700/50 bg-slate-900/80 p-8 shadow-2xl shadow-black/40 backdrop-blur-sm">
                <div className="text-sm font-bold uppercase tracking-[0.25em] text-orange-400">Access Control</div>
                <p className="mt-6 text-lg font-semibold leading-snug text-white">Badge & Physical Security Systems</p>
                <p className="mt-4 text-base leading-relaxed text-slate-400">Physical access control remains separate</p>
                <div className="mt-6 h-1 w-16 bg-orange-500/90" />
              </article>
            </div>
            <div className="max-w-4xl">
              <p className="text-lg leading-relaxed text-slate-300">
                <strong className="text-white">Existing systems remain the system of record.</strong> T-REX AI OS records certification state, verification events, and historical status at the time of verification. The platform preserves evidence of compliance state without mutating source systems.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl space-y-16 px-6">
            <div className="rounded-3xl bg-slate-900/30 p-10 backdrop-blur-sm">
              <header className="max-w-4xl space-y-5">
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-orange-400">Integrations & APIs</p>
                <h2 className="text-4xl font-bold leading-tight text-white md:text-5xl">This system can integrate with existing HR, training, and compliance systems.</h2>
              </header>
              <div className="mt-16 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                <article className="space-y-4 border-b border-white/8 pb-8">
                  <h3 className="text-2xl font-bold text-orange-400">Manual Entry</h3>
                  <p className="text-base leading-relaxed text-slate-300">
                    Manual administrative entry by authorized compliance administrators
                  </p>
                </article>
                <article className="space-y-4 border-b border-white/8 pb-8">
                  <h3 className="text-2xl font-bold text-amber-400">Bulk CSV Import</h3>
                  <p className="text-base leading-relaxed text-slate-300">
                    <span className="text-amber-300 font-semibold">Not available in production</span> — manual entry required
                  </p>
                </article>
                <article className="space-y-4 border-b border-white/8 pb-8">
                  <h3 className="text-2xl font-bold text-orange-400">API Ingestion</h3>
                  <p className="text-base leading-relaxed text-slate-300">
                    API-based ingestion where enabled — designed to coexist with existing enterprise systems
                  </p>
                </article>
              </div>
              <div className="mt-12 max-w-4xl">
                <p className="text-lg leading-relaxed text-slate-400">
                  The platform exposes controlled integration surfaces for certification data ingestion and verification event logging. API availability and documentation are provided during technical review.
                </p>
              </div>
            </div>
          </div>
